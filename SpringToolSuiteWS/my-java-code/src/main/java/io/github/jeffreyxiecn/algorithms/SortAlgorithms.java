...
public class SortAlgorithms {
    ...
    private static void merge(int[] array, int[] helper, int low, int middle, int high) {
        ...
        // when the while loop ends, if helperRight <= high (all the elements on the left portion have been
        // examined,
        // the non-examined part in the right portion are already in their final places, nothing needs to be
        // done
    ...
    private static void quickSort(int[] array, int left, int right) {
        ...
        // after partition, all the elements in array[left...index-1] are <= the elements in array[index,
        // right]
        if (left < index - 1) {
